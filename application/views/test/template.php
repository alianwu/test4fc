...
<head>
    ...
    <?php echo HTML::script(STATIC_SITE_URL .'public/js/jquery-2.0.2.min.js'); ?>
    <?php echo HTML::script(STATIC_SITE_URL .'public/js/jquery.pjax.js'); ?>
    <?php echo HTML::style(STATIC_SITE_URL .'public/css/pure-min.css'); ?>
    <?php echo HTML::style(STATIC_SITE_URL .'public/css/awesome/font-awesome.min.css'); ?>
