...
<div class="pure-u-2-5">
  ...
  <br />
  <br />
  <p>已有账户，请 <?php echo HTML::anchor('manager_sigin', '登陆', array('class'=>'pure-button pure-button-success')); ?></p>
</div><div class="pure-u-3-5">
  <?php echo Form::open('manager_sigup/check', array('class'=>'pure-form pure-form-aligned')); ?>
    <fieldset>
        <legend>用户注册</legend>
        ...
        <div class="pure-control-group">
            ...
            <?php echo Form::password('repassword', '', array('id'=>'repassword', 'placeholder'=>'确认密码')); ?>
        ...
        <div class="pure-control-group">
            <label> </label>
            <?php echo Captcha::instance('default')->html_render(); ?> <?php if(isset($error['captcha'])): ?><span class="info-error"><?php echo $error['captcha']; ?></span><?php endif; ?>
        </div>
        <div class="pure-controls">
            <label for="cb" class="pure-checkbox">
            <input id="cb" type="checkbox" name="agree"> 同意并遵 <?php echo $Accounts->site; ?> 守用户协议 <?php echo HTML::anchor('', '?'); ?>
            <?php if(isset($error['agree'])): ?><span class="info-error">必须同意协议内容</span><?php endif; ?>
            </label>
            <?php echo Form::hidden('redi', Arr::get($_POST, 'redi', urlencode('http://puhua.co/'))); ?>
